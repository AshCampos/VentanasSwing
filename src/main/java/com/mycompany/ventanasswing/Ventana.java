package com.mycompany.ventanasswing;
...
public class Ventana extends JFrame {
    ...
    public Ventana(String string) throws HeadlessException, MalformedURLException {
        super(string);
        this.setSize(800, 600);
        layout = new GridLayout(2, 2);
        this.getContentPane().setLayout(layout);

        //Panel 1anel1.setBackground(Color.CYAN);
        panel1 = new JPanel();
        ...
        try {
            ...
            Image imagen = new ImageIO.read(url);
        ...
        //Panel 4
        panel4 = new JPanel();
        panel4.setBackground(new Color(222, 245, 284));
